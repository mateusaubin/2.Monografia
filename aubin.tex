...
%		Explicar a Metodologia:  Vai ter capítulo específico
	...
	de voz a 1300 bits por segundo'' \cite[p.~348]{IBMSAGE1983}.
...
no Capítulo 2 serão abordadas questões relativas à gerência de redes e seu 
principal protocolo, o \hyperref[siglas]{SNMP};
no Capítulo 3 é apresentado e detalhado o conceito de Internet das Coisas, 
detalhando desde sua origem e definição, até os desafios e as oportunidades 
proporcionadas por este paradigma;
o Capítulo 4 apresenta a proposta deste trabalho para unir os conceitos 
anteriormente apresentados, combinando as estratégias da gerência de redes com 
a Internet das Coisas;
o Capítulo 5 versa sobre o planejamento do desenvolvimento deste trabalho, ou 
seja, como ele prosseguirá de forma a atingir seus objetivos.
...
%		Objetivo: Para facilitar a gestão de dispositivos inteligentes
	...
	mesmo tempo, mantendo a interoperabilidade com padrões já estabelecidos.
...
Um maior detalhamento ainda é possível na visão de \citetexto{Fonseca2002}, 
onde deve-se dividir a pesquisa experimental em duas categorias, a de campo e 
a de laboratório, realizada neste trabalho.
...
serviços de conectividade, demonstrando o seu valor e provando, na prática,
...
% performance management, and accounting management.
	...
	define as cinco principais categorias da gerência de redes, conhecidas como 
	o modelo \hyperref[siglas]{FCAPS} e que contempla o gerenciamento de:
...
importância para empresas pois auxilia na cobrança a clientes internos e 
...
Interessada principalmente na qualidade dos serviços de rede, a finalidade 
...
rede, sendo as principais: \textit{throughput}, \textit{delay}, porcentagem de 
...
\item \textbf{Dispositivo:}
	Todo e qualquer equipamento conectado à rede e que deseja-se que faça parte
da gerência. 
...
É constituído, geralmente, por uma máquina com abundância de recursos;
...
\hyperref[siglas]{MIB} representado através da \hyperref[siglas]{SMI};
...
básica e facilmente implementável de gerência de redes que poderia ser 
utilizado para atender num curto prazo as necessidades de gerência. Devido ao 
...
desde servidores a roteadores e \textit{no-breaks}.
...
Como nenhuma solução é perfeita para todos os casos, o \hyperref[siglas]{SNMP} também sofreu 
grandes críticas. 
...
a apresentar ao leitor suas principais características, além de uma visão mais 
...
dando a devida importância à segurança \cite{Clemm2006}, fazendo com que as 
...
tempo de desenvolvimento da versão, gerentes deixaram de usar o protocolo no contexto de 
...
expressas de maneira compacta e precisa, evitando a complexidade associada a
decisão de qual operação é válida dado o estado do objeto.
...
O desenvolvimento deste trabalho se dará conforme o cronograma apresentado 
pela \autoref{fig:crono}, tendo como principal atividade o desenvolvimento do 
protótipo de um software para o \textit{gateway} 
\hyperref[siglas]{IoT}---\hyperref[siglas]{SNMP}.
Observando-se de maneira mais ampla, o desenvolvimento pode ser detalhado com 
...
\begin{itemize}
	...
	\item \textbf{Artigo:}
Assim como o protótipo do \textit{gateway}, o artigo final compõe um dos 
entregáveis deste trabalho.
Seu desenvolvimento se dará na segunda metade do tempo previsto em cronograma 
por depender das decisões, experiências e resultados do desenvolvimento do 
protótipo.
Ao final da escrita do artigo, detalhando o acontecido no desenvolvimento da 
solução e os resultados encontrados, haverá a apresentação do mesmo para a 
banca avaliadora;

	\item \textbf{Análise:}
Prevê-se logo no começo do tempo alocado em cronograma um período que 
compreenderá atividades de análise e planejamento do desenvolvimento.
Entre as atividades previstas estão a definição de ambientes e linguagens de 
desenvolvimento, assim como as bibliotecas necessárias.
Ainda nesta fase haverá um detalhamento técnico da solução proposta, visando 
seguir padrões de desenvolvimento de software e obter maior qualidade no 
resultado final que, mesmo em caráter de protótipo, pode ser útil à 
comunidade, tanto profissional quanto acadêmica;

	\item \textbf{Desenvolvimento:}
Ocupando quase a metade do tempo previsto em cronograma, as atividades de 
desenvolvimento caracterizam a efetiva codificação e integração da solução 
proposta.
Como produto final desta fase objetiva-se por obter um software capaz de 
executar em ambientes embarcados, predominantemente Linux, e desempenhar a 
função de integrador entre redes da Internet das Coisas e ambientes de 
gerência de redes.
Esta atividade foi dividida, no cronograma, em cinco outras atividades menores 
em termos dos principais componentes do protótipo, sendo eles:
agente experimental em protocolo de \hyperref[siglas]{IoT};
camada de comunicação com protocolos de \hyperref[siglas]{IoT};
camada de comunicação com protocolo \hyperref[siglas]{SNMP};
camada de tradução entre os diferentes protocolos;
e os módulos de filtro e agrupamento de requisições.
Todas estas atividades são fundamentais para a obtenção do resultado esperado, 
ou seja, o protótipo de \textit{gateway} 
\hyperref[siglas]{IoT}---\hyperref[siglas]{SNMP};

	\item \textbf{MIB:}
De forma a atingir os objetivos de filtro e agregação de valores das consultas 
\hyperref[siglas]{SNMP}, conforme detalhado na proposta deste trabalho, é 
necessário o desenvolvimento de uma \hyperref[siglas]{MIB} própria e criada 
especificamente para este fim.
Assim como a análise, este é um dos passos iniciais e que definirá o rumo do 
restante do trabalho, merecendo especial atenção;

	\item \textbf{Validação:}
A fim de comprovar a funcionalidade do protótipo, e, consequentemente, a 
viabilidade da proposta deste trabalho, está previsto o tempo de um mês ao fim 
do desenvolvimento.
Neste momento serão realizados testes integrados em um ambiente que simule um 
contexto de automação residencial e permita, entre outros, avaliar as forças, 
as fraquezas e as oportunidades relativas a solução proposta.
