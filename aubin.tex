...
Caso seja possível obter um dispositivo de uso específico para IoT planeja-se 
...
em um dispositivo comum, como um PC por exemplo;

	\item \textbf{Gateway:}
Um PC ou outro dispositivo com maior poder de processamento do que os 
...
como uma ponte entre eles;
	...
	\item \textbf{Gerente:}
Aplicativo de gerência de redes que se comunique usando SNMP e executando em 
um PC.
...
máximo e média);
e a execução de requisições padrão do SNMP.
