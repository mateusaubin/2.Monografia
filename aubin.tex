...
{\citetexto{Sundmaeker2010}}
	...
	O contínuo aumento na capacidade de processamento de dispositivos 
	computacionais e a redução de custos possibilitou uma nova revolução 
...
\subsection{Definição}
		...
		definições por Kevin Ashton e David \citetexto{Brock2001} do Auto-ID 
		Labs e da União Internacional de Telecomunicações \citetexto{ITU2005}. 
		...
		\begin{itemize}
			...
			identificação e rastreamento de objetos, baseadas principalmente 
		...
		Segundo \citetexto{Simpson2005}, no Oxford English Dictionary, a 
		...
		versar sobre dispositivos inteligentes e conectados à Internet sem a 
		necessidade de intermediários. Segundo \citetexto{Buckley2006} a 
		transformação no conceito de IoT é resultado tanto de avanços 
		tecnológicos quanto de interesse mercadológico impulsionado pelos 
...
\subsection{Importância}
		...
		conhecimento, gerando, segundo \citetexto{carr2010}, mudanças até 
		...
		interconectados fez com que especialistas como \citetexto{Hung2012} da 
		...
		\begin{quote}
			...
			conhecimento e, finalmente, conhecimento.~
			\cite{Cisco2011}.
		\end{quote}
		
		%TODO adicionar figura da piramide do conhecimento da Cisco
		...
		%TODO desafios (poder computacional, bateria, segurança)
