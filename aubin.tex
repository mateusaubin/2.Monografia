...
% == Objetivos ==
% deixar 3
%  - manter copatibilidade com ferramentas e protocolos ja existentes
%
%=======================================================================
...
Uma ver apresentado o conceito de Internet das Coisas e conhecidos seus 
...
improvável que tais esforços possibilitem uma gerência sem a intervenção de 
operadores.


Ainda que a autoconfiguração forneça um objetivo de longo prazo, a necessidade 
de configurar dispositivos, mesmo que em situações experimentais e de escala 
reduzida, é um problema que já se enfrenta atualmente.
Desta forma, percebe-se o desejo de um método padronizado para a gerência de 
configuração destes dispositivos, uma vez que cada sistema operacional (por 
vezes específico para o domínio de aplicação) apresenta mecanismos próprios de 
...
Semelhanças existem também no que diz respeito à falta de padronização destes 
dispositivos, explicitando ainda mais a sua relação com a gerência de redes 
clássica e o SNMP.
...
postas à prova ao longo dos anos através do SNMP.
...
como um subproduto da mescla proposta entre SNMP e IoT, possibilitando o 
