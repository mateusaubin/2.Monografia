...
{\citetexto{Sundmaeker2010}}
	...
	dia-a-dia. Tomando por referência a lei de \citetexto{Moore1965}, que dita 
...
%	nos campos relacionados. 
	...
	\citetexto{Sung2007}, boa parte das aplicações de WSNs são utilizadas para 
	o monitoramento de ambientes físicos. A comunicação nas WSNs acontece 
	somente entre nós vizinhos  e é isolada da Internet, embora um nó 
	específico da rede, que atua como coordenador, possa prover conectividade 
	com redes externas \cite{Perera2013}.
	...
	Pesquisas relacionando RFID e WSNs, em direção a uma visão de Internet das 
	Coisas, foram realizadas por \citetexto{Sung2007}, \citetexto{Zhang2011a} 
	e \citetexto{Hada2011}, comprovando a viabilidade da proposta.
