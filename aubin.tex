...
%		Internet, até a IoT
	...
	O aumento contínuo na capacidade de processamento dos dispositivos 
	computacionais aliado a redução de custos possibilitou uma nova revolução 
	tecnológica. %TODO quem afirma isto?
	Munidos de circuitos integrados e \textit{microchips}, cada 
	...
	Ainda que não seja uma ideia nova, \citetexto{Turck2013} pontua que a 
	...
	academia quanto da indústria se mobilizaram em torno do conceito 
	\cite{Atzori2010b}. 
	Entidades governamentais reconheceram também a IoT como um paradigma 
	promissor, promovendo iniciativas de pesquisa e desenvolvimento na China, 
	Japão, Estados Unidos e União Europeia 
	\cite[p.~16]{Sundmaeker2010}.
...
%		Objetivo: Para facilitar a gestão de dispositivos inteligentes
	...
	fora do controle das companhias, este novo paradigma apresenta-se um 
...
%	deveriam ser estendidos para suportar a gestão da IoT''
	Compartilhando desta motivação, autores como \citetexto{Wang2012}
	%TODO Referências
	afirmam que os protocolos de gerenciamento devem também manter a 
	compatibilidade com os modelos já existentes, sendo, se necessário, 
	estendidos para dar suporte aos desafios da IoT.
	
	% neste ponto falta deixar claro qual o problema que estamos estudando
	
	% aqui deves abrir uma secao de Objetivos
...
% DO TRABALHO...
	...
	% em nivel de prototipo, nao de produto acabado
