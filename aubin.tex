...
%TODO Traçar um histórico da evolução tecnológica que culminou na IoT. Vindo 
%		desde a invenção do computador, das redes de computadores e a 
%		Internet, até a IoT
	...
	tecnológica. Munidos de circuitos integrados e \textit{microchips}, cada 
	vez mais os computadores avançam em direção à ubiquidade.
	...
	Segundo \citetexto{Turck2013}, ainda que não seja uma ideia nova, a 
	implementação de uma Internet das Coisas (IoT) não era viável devido a 
	fatores como a complexidade e o custo da criação de uma rede composta de 
	dispositivos embarcados em objetos do dia-a-dia. 
	Tomando por referência a lei de \citetexto{Moore1965}, que dita 
	que o número de transístores em um circuito integrado dobra 
	aproximadamente a cada dois anos, é improvável que esta tendência, de 
	...
	pervasiva, atingida com a ajuda da IoT, pesquisadores tanto da academia 
	quanto da indústria se mobilizaram em torno do conceito 
	\cite{Atzori2010b}. 
	Entidades governamentais reconheceram também a IoT como um paradigma 
	promissor, com iniciativas de pesquisa e desenvolvimento na China, Japão, 
	Estados Unidos e União Europeia \cite[p.~16]{Sundmaeker2010}.
	...
	quadrinhos Homem Aranha, escrita pro Stan Lee.}. 
...
\section{Justificativa / Problema}
%	Abordar
...
%		Objetivo: Para facilitar a gestão de dispositivos inteligentes
	...
	permitem, dentre outras funções, acesso a redes e, principalmente, à 
	Internet.
	
	Paralelamente a esta tendência, seguindo as previsões de 
	\citetexto{Moore1965} e \citetexto{Gilder2007}, por exemplo, a capacidade 
	de equipamentos e redes continua a aumentar, tornando cada vez mais 
	atraente e economicamente viável a visão de um mundo conectado 
	\cite{Ding2009}.
	...
	A difusão dos aparelhos capazes de acessar a Internet criou um novo 
	paradigma que está transformando a gestão de Tecnologia da Informação (TI) 
	\cite{ZdnetBYOD}. Batizado de Traga Seu Próprio Dispositivo (BYOD), 
	este modelo aponta para um futuro onde colaboradores não estarão mais 
	limitados aos equipamentos das organizações, podendo usar dispositivos de 
	sua preferência para trabalho e lazer.
	
	Ocasionando um significativo aumento na quantidade de ativos 
	fora do controle da organização, este novo paradigma apresenta-se um 
	desafio para as áreas de segurança da informação e gerência de redes.
	Empresas como \citetexto{CiscoBYOD}, \citetexto{HP2013} e 
	\citetexto{Motorola2011} identificaram este desafio como uma oportunidade 
	de negócio, lançando diferentes produtos visando prover soluções para 
	controlar e, enfim, viabilizar a realização do BYOD nas organizações.
	
	Assim como o BYOD, a Internet das Coisas trará consigo uma vasta gama de 
	novos aparelhos que carecem de diretivas de gestão \cite{Atzori2010b}.
	Apesar das soluções propostas para o cenário BYOD, não há um consenso 
	sobre mecanismos específicos de gerência, gerando soluções proprietárias e 
	que não colaboram entre si. 
	
	Visando manter a interoperabilidade entre dispositivos, há, nas pesquisas 
	de IoT, um consenso referente ao uso de IP, mais especificamente o IPv6, 
	como o protocolo padrão de comunicação. 
	%TODO Incluir as referências
%	``Modelos e protocolos de gerenciamento de Internet 
%	deveriam ser estendidos para suportar a gestão da IoT''
	Compartilhando desta motivação, autores como \citetexto{Wang2012} e OUTROS
	%TODO Referências
	afirmam que os protocolos de gerenciamento devem também manter a 
	compatibilidade com os modelos já existente, sendo, se necessário, 
	...
	gerência de redes tradicional aplicados ao contexto de Internet das Coisas.
	...
	Falar que é possível usar SNMP como protocolo pra gerir IoT e explicar que 
	vou propor melhorias específicas para este caso de uso.
	% +padronizacao
	% +aproveitamento de tecnologias estabelecidas
	% -pesado
...
\subsection{Smart Objects}
	...
	usuários), e a consciência do seu contexto \cite{Beigl2001}. Os autores 
	ainda enfatizam que tais objetos ``serão deliberadamente limitados em sua 
	capacidade computacional, memória e poder de processamento a níveis 
	adequados para um propósito específico''. Seguindo esta tendência, 
	\citetexto{Mattern2010a} prevêem que a tecnologia caminha em direção a um 
	modelo onde Objetos Inteligentes efetivamente se comunicam entre eles, 
	serviços na Internet e seus usuários.
	...
	\citetexto{Beigl2001}, \citetexto{Gellersen2004}, 
