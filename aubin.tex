%TODO
%
% verificar a lista de siglas
% verificar se as definições estão junto com a primeira ocorrência do termo
% conferir se todas as figuras/tabelas são referenciadas no texto (fig 3, por exemplo)
% sempre que uma citação tiver o "et al.", a concordância do verbo seguinte deve seguir o plural
