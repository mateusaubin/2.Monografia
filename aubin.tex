...
%	\cite{Zhu2010}
%	while the WSN can realize the short- distance communication among the 
%	objects by constructing wireless networks in ad-hoc manners. However, it’s 
%	difficult to connect the WSN and mobile communication networks or the 
%	Internet 
%	with each other because it lacks of uniform standardization in 
%	communication 
%	protocols and sensing technologies and the data from WSN cannot be 
%	transmitted 
%	in long distance with the limitation of WSN’s transmission protocols.
...
% \cite{Mattern2010a} é contra gateways
%TODO Smart Objects
