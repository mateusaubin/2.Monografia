...
% reforçar no capítulo 3 o significado da sigla IoT
% é importante já preveres como será validada a proposta (simulação, protótipo, etc.).
% == Proposta ==
...
\begin{figure}
	%TODO tirar o azul da linha SNMP 3
...
%TODO Footnotes: BigData, Hadoop, Hana
...
ainda mais a relação com a gerência de redes clássica e o \hyperref[siglas]{SNMP}.
...
solução proposta.
%TODO falar mais do gateway:
% acho importante destacar a certa facilidade que se tem hoje em dia de
% implementar a funcionalidade do gateway em um modem ou roteador doméstico. 
% Podes mencionar que vários desses dispositivos se baseiam em
% micro-distribuições Linux como BusyBox (http://www.busybox.net/about.html),
% OpenWRT (http://openwrt.org) e DD-WRT (http://dd-wrt.com/site/index), 
% e que portanto podem ser modificadas para incorporar o gateway.
