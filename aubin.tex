...
{Alguém}
	...
	O contínuo aumento na capacidade de processamento de dispositivos computacionais e a redução de custos possibilitou uma nova revolução tecnológica. Munidos de circuitos integrados e microchips cada vez mais os computadores avançam em direção a ubiquidade.
	
	No atual cenário tecnológico já é possível colocar em prática, de maneira economicamente viável, algumas das ideias vislumbradas por \citetexto{Weiser1991}. A integração entre dispositivos computacionais e a vida cotidiana apresenta um grande desafio para diversas áreas do conhecimento.
	
	Apesar de não ser uma ideia nova, a implementação de uma ``Internet das Coisas'' era difícil devido a fatores como a complexidade e o custo de criar uma rede de dispositivos embarcados em objetos do dia-a-dia.
