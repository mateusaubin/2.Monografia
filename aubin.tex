...
\citetexto{perkins1997understanding} corrobora ao afirmar que, embora 
...
porém a nomenclatura é ainda pouco usada.
...
\begin{figure}
	...
	\begin{minipage}{.8\textwidth}
		\includegraphics[width=\textwidth]{snmp_stack}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.60\textwidth}
        \includegraphics[height=9cm,keepaspectratio=true]{snmp_pdu_v3}
		%\fonte{muito texto longo longo longo}
    \end{subfigure}
\hfill
    \begin{subfigure}[b]{0.30\textwidth}
        \includegraphics[height=9cm,keepaspectratio=true]{snmp_pdu}
		%\fonte{muito texto longo longo longo}
    \end{subfigure}
\\
    \begin{subfigure}[b]{0.27\textwidth}
        \includegraphics[height=4cm,keepaspectratio=true]{snmp_pdu_v1}
		%\fonte{muito texto longo longo longo}
    \end{subfigure}
\hspace{.1\textwidth}
    \begin{subfigure}[b]{0.27\textwidth}
        \includegraphics[keepaspectratio=true]{snmp_pdu_varbinds}
		%\fonte{muito texto longo longo longo}
    \end{subfigure}
...
SNMP das versões 1 e 2 comparado com a versão 3 e, com a ajuda da
\autoref{fig:snmp-pdu}, percebe-se que as funcionalidades de segurança 
incorrem um custo tanto no tamanho dos pacotes quanto na simplicidade do 
protocolo.
...
com ressalvas no caso do \textit{get-bulk}.
...
Abaixo apresenta-se um detalhamento\footnote{
	...
	\citetexto{stallings1999snmp} e 
	\citetexto{Mauro2009}.
} das mensagens previstas no protocolo SNMP no que diz respeito a suas PDUs.
